...
fn int_i8() {
    ...
    assert_eq!(alisa::parse_abf(i8_bytes), Some(alisa::ABFValue::I8(-2)));
...
fn int_i16() {
    ...
    assert_eq!(alisa::parse_abf(i16_bytes), Some(alisa::ABFValue::I16(259)));
...
fn int_i32() {
    ...
    assert_eq!(alisa::parse_abf(i32_bytes), Some(alisa::ABFValue::I32(65793)));
...
fn int_i64() {
    ...
    assert_eq!(alisa::parse_abf(i64_bytes), Some(alisa::ABFValue::I64(4295033089)));
